        ...
        <div className="modal-box dark:bg-slate-900">
          <form onSubmit={handleSubmit(onSubmit)} method="dialog">
            ...
            <div className="mt-4 space-y-2">
              ...
              />
              <br/>
              {errors.email && <span className="text-sm text-red-500 ml-2">This field is required</span>}
            </div>
            {/* Password */}
            <div className="mt-4 space-y-2">
              <span>Password:</span>
              ...
              />
              <br/>
              {errors.password && <span className="text-sm text-red-500 ml-2">This field is required</span>}
            </div>
            {/* Button */}
